...
def resolve_matching_names(
    ...
    of the query regular expressions. This means that the ordering is dictated by the order of the query keys
    and not the order of the target strings.

    If the :attr:`preserve_order` is False, the ordering of the matched indices and names follows the order
    of the target strings (i.e., the order in which they appear in :attr:`list_of_strings`).
